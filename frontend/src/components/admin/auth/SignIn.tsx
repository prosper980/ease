            ...
            <Form className='p-3 border border-slate-400 space-y-3' method='post'>
                ...
                <div>
                    <label htmlFor="admin_user_name">
                        ...
                        focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" name="username" id="admin_user_name" placeholder='User name'/>
                    </label>
                </div>
                ...
                <div>
                    <label htmlFor="admin_password">
                        ...
                        focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" type="password" name="password" id="admin_password" placeholder='Password'/>
                    </label>
                </div>

                <button className='w-full rounded p-2 text-center text-white transition border-0 bg-green-500 hover:bg-green-300' type='submit'> Sign in </button>
